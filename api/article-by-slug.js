...
if (!supabaseUrl || !supabaseAnonKey) {
  console.warn('⚠️ Supabase não configurado no servidor. Endpoint /api/article/[slug] não funcionará.')
}
    ...
    <footer>
      <div class="footer-inner">
        ...
        <div class="footer-links">
          ...
          <a href="mailto:dpo@valtun.com.br">dpo@valtun.com.br">dpo@valtun.com.br</a>
        </div>
      </div>
